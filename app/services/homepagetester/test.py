...
from app.logger import bool_logger
import time
...
class HomePageTester(BaseTester):
    ...
    def test_all_links(self):
        ...
        for i in range(1, 6):
            ...
            while flag:
                try:
                    div_link = self.find_element(
                        r"""//*[@id="root"]/div[2]/div[3]/div/div/div/div[2]/div[2]/div[1]/div/ul/li[1]/a""".format(i))
        ...
        for i in range(1, 3):
            ...
            while flag:
                try:
                    div_link = driver.find_element_by_xpath(
                        r"""//*[@id="root"]/div[1]/div[3]/div/div/div/div[2]/div[2]/div[2]/ul/li[{}]/a""".format(i))
                    div_link.send_keys(Keys.CONTROL + Keys.RETURN)
                    flag = False
